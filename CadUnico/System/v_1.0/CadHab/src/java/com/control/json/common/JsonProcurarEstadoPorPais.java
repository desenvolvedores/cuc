 ...
 * @version 1.0
 */
public class JsonProcurarEstadoPorPais extends javax.servlet.http.HttpServlet {
    ...
    protected void processRequest(javax.servlet.http.HttpServletRequest request, javax.servlet.http.HttpServletResponse response)
        ...
        try {
            ...
            if (com.settings.GerenciadorAcesso.checkAuthentication(token, userKey)) {
                ...
                com.common.Estado estado = jsonMgr.parseEstado(json);
                
                if (estado.getIdPais() > 0) {
                    
                    pgsql.common.EstadoDAO estadoDAO = new pgsql.common.EstadoDAO();
                    java.util.List<com.common.Estado> estados = estadoDAO.procurarEstadoPorIDPais(estado.getIdPais());
                    out.print(jsonMgr.parseJsonListaEstado(estados));
                    
                } else {
                    
                    com.sys.Message message = new com.sys.Message();
                    message.setCode(2);
                    message.setMessage("Não foi possível obter os dados dos estados do país selecionado!");
            ...
            com.sys.Message message = new com.sys.Message();
            message.setCode(0);
            message.setMessage("O servidor não pôde obter os estados do país selecionado!");
            com.data.MessageManager messMgr = new com.data.MessageManager();
            out.print(messMgr.parseJson(message));
