 ...
 * @version 1.0
 */
public class JsonProcurarEmpresaPorFantasia extends javax.servlet.http.HttpServlet {
        ...
        try {
            ...
            if (com.settings.GerenciadorAcesso.checkAuthentication(token, userKey)) {
                ...
                if (! empresa.getNomeFantasia().isEmpty()) {
                    ...
                    java.util.List<com.sys.social.Empresa> empresas = empresaDAO.procurarEmpresaPorRazaoSocial(empresa.getNomeFantasia());
                    ...
                    message.setCode(2);
                    message.setMessage("Você precisa informar o nome fantasia da empresa para efetuar a pesquisa!");
