 ...
 * @version 1.0
 */
public class JsonSelecionarProfissionalIndividuo extends javax.servlet.http.HttpServlet {
        ...
        try {
            ...
            if (com.settings.GerenciadorAcesso.checkAuthentication(token, userKey)) {
                ...
                if (profissional.getId() > 0) {
                    ...
                    profissional = profissionalDAO.selecionarProfissionalIndividuoPorID(profissional.getId());
