 ...
 * @version 1.0
 */
public class JsonProcurarFamiliaPorSituacaoRemocao extends javax.servlet.http.HttpServlet {
        ...
        try {
            ...
            if (com.settings.GerenciadorAcesso.checkAuthentication(token, userKey)) {
                ...
                if (! familia.getRemocaoFamilia().isEmpty()) {
                    ...
                    java.util.List<com.sys.social.Familia> familias = familiaDAO.procurarFamiliaPorSituacaoRemocao(familia.getSituacaoRemocao());
                    out.print(jsonMgr.parseJsonListaFamilia(familias));
                    
                } else {
                    
                    com.sys.Message message = new com.sys.Message();
                    message.setCode(2);
                    message.setMessage("Você precisa informar a situação da remoção da família para efetuar a pesquisa!");
            ...
            com.sys.Message message = new com.sys.Message();
            message.setCode(0);
            message.setMessage("O servidor não pôde obter os dados das famílias!");
            com.data.MessageManager messMgr = new com.data.MessageManager();
            out.print(messMgr.parseJson(message));
            ...
            com.sys.Message message = new com.sys.Message();
            message.setCode(0);
            message.setMessage("O banco de dados retornou um erro durante a seleção dos dados das famílias.<br />Contate o administrador do sistema!");
            com.data.MessageManager messMgr = new com.data.MessageManager();
            out.print(messMgr.parseJson(message));
