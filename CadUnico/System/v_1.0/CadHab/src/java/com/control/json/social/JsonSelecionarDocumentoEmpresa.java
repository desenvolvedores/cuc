 ...
 * @version 1.0
 */
public class JsonSelecionarDocumentoEmpresa extends javax.servlet.http.HttpServlet {
        ...
        try {
            ...
            if (com.settings.GerenciadorAcesso.checkAuthentication(token, userKey)) {
                ...
                if (documento.getId() > 0) {
                    ...
                    documento = documentoDAO.selecionarDocumentoEmpresaPorID(documento.getId());
