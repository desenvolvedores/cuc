 ...
 * @version 1.0
 */
public class JsonProcurarNucleoPorSetor extends javax.servlet.http.HttpServlet {
        ...
        try {
            ...
            if (com.settings.GerenciadorAcesso.checkAuthentication(token, userKey)) {
                ...
                if (! nucleo.getNome().isEmpty()) {
                    ...
                    message.setCode(2);
                    message.setMessage("Você precisa informar o setor do núcleo para realizar a pesquisa!");
