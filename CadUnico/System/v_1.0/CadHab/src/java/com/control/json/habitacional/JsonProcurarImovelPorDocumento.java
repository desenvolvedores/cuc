 ...
 * @version 1.0
 */
public class JsonProcurarImovelPorDocumento extends javax.servlet.http.HttpServlet {
    ...
    protected void processRequest(javax.servlet.http.HttpServletRequest request, javax.servlet.http.HttpServletResponse response)
        ...
        try {
            ...
            if (com.settings.GerenciadorAcesso.checkAuthentication(token, userKey)) {
                ...
                if (! imovel.getNumDocPropriedade().isEmpty()) {
                    
                    pgsql.sys.habitacional.ImovelDAO imovelDAO = new pgsql.sys.habitacional.ImovelDAO();
                    java.util.List<com.sys.habitacional.Imovel> imoveis = imovelDAO.procurarImovelPorNumDocumento(imovel.getNumDocPropriedade());
                    ...
                    message.setCode(2);
                    message.setMessage("Você precisa informar o número do documento do imóvel para efetuar a pesquisa!");
