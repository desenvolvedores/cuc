                ...
                if (! nucleo.getNome().isEmpty() 
                    ...
                    if (nucleoDAO.inserirNucleo(nucleo) > 0) {
                        ...
                        if (nucleoTemp.get(0) != null) {
                            ...
                            nucleo.getInfraestruturaUrbana().setIdNucleo(nucleoTemp.get(0).getId());
                            nucleo.getProgramaHabitacional().setIdNucleo(nucleoTemp.get(0).getId());
                            nucleo.getSituacaoFundiaria().setIdNucleo(nucleoTemp.get(0).getId());
                            nucleo.getAcaoNucleo().setIdNucleo(nucleoTemp.get(0).getId());
                            nucleo.getAspectoAmbiental().setIdNucleo(nucleoTemp.get(0).getId());
                                ...
                                if (programaDAO.inserirProgramaHabitacional(nucleo.getProgramaHabitacional()) > 0) {
                                    ...
                                    if (fundiariaDAO.inserirSituacaoFundiaria(nucleo.getSituacaoFundiaria()) > 0) {
                                        ...
                                        if (acaoDAO.inserirAcaoNucleo(nucleo.getAcaoNucleo()) > 0) {
                                            ...
                                            com.sys.urbano.AcaoNucleo acaoTemp = acaoDAO.selecionarAcaoNucleoPorIDNucleo(nucleo.getId());
                                            ...
                                            if (acaoTemp != null) {
                                                ...
                                                if (ambientalDAO.inserirAspectoAmbiental(nucleo.getAspectoAmbiental()) > 0) {
                                                    ...
                                                    com.sys.urbano.AspectoAmbiental ambientalTemp = ambientalDAO.selecionarAspectoAmbientalPorIDNucleo(nucleo.getId());
                                                    ...
                                                    if (ambientalTemp != null) {
                                                        ...
                                                        if (! nucleo.getAspectoAmbiental().getApp().getCorpoDagua().isEmpty() && ! nucleo.getAspectoAmbiental().getApp().getBrejoCharco().isEmpty() 
                                                            ...
                                                            nucleo.getAspectoAmbiental().getApp().setIdAmbiental(ambientalTemp.getId());
                                                            ...
                                                            if (appDAO.inserirApp(nucleo.getAspectoAmbiental().getApp()) <= 0) {
                                                                ...
                                                                com.sys.Message message = new com.sys.Message();
                                                                message.setCode(0);
                                                                message.setMessage("Não foi possível cadastrar os dados da APP!");
                                                                com.data.MessageManager messMgr = new com.data.MessageManager();
                                                                out.print(messMgr.parseJson(message));
                                                                return;
