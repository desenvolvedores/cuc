 ...
 * @version 1.0
 */
public class JsonProcurarNucleoPorNome extends javax.servlet.http.HttpServlet {
        ...
        try {
            ...
            if (com.settings.GerenciadorAcesso.checkAuthentication(token, userKey)) {
                ...
                if (! nucleo.getNome().isEmpty()) {
                    ...
                    java.util.List<com.sys.urbano.Nucleo> nucleos = nucleoDAO.procurarNucleoPorNome(nucleo.getNome());
