 ...
 * @version 1.0
 */
public class JsonProcurarNucleoExistentePorNome extends javax.servlet.http.HttpServlet {
    ...
    protected void processRequest(javax.servlet.http.HttpServletRequest request, javax.servlet.http.HttpServletResponse response)
        ...
        try {
            ...
            if (com.settings.GerenciadorAcesso.checkAuthentication(token, userKey)) {
                ...
                if (! nucleo.getNome().isEmpty() && nucleo.getId() > 0) {
                    
                    pgsql.sys.urbano.NucleoDAO nucleoDAO = new pgsql.sys.urbano.NucleoDAO();
                    java.util.List<com.sys.urbano.Nucleo> nucleos = nucleoDAO.procurarNucleoExistentePorNome(nucleo);
                    ...
                    message.setCode(2);
                    message.setMessage("Você precisa informar o nome do núcleo para realizar a pesquisa!");
