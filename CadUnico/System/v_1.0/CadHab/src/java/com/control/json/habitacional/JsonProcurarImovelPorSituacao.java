 ...
 * @version 1.0
 */
public class JsonProcurarImovelPorSituacao extends javax.servlet.http.HttpServlet {
    ...
    protected void processRequest(javax.servlet.http.HttpServletRequest request, javax.servlet.http.HttpServletResponse response)
        ...
        try {
            ...
            if (com.settings.GerenciadorAcesso.checkAuthentication(token, userKey)) {
                ...
                if (! imovel.getSituacao().isEmpty()) {
                    
                    pgsql.sys.habitacional.ImovelDAO imovelDAO = new pgsql.sys.habitacional.ImovelDAO();
                    java.util.List<com.sys.habitacional.Imovel> imoveis = imovelDAO.procurarImovelPorSituacao(imovel.getSituacao());
                    ...
                    message.setCode(2);
                    message.setMessage("Você precisa informar a situação do imóvel para efetuar a pesquisa!");
