 ...
 * @version 1.0
 */
public class JsonSelecionarRemanejamento extends javax.servlet.http.HttpServlet {
        ...
        try {
            ...
            if (com.settings.GerenciadorAcesso.checkAuthentication(token, userKey)) {
                ...
                if (remanejamento.getId() > 0) {
                    ...
                    remanejamento = reassentamentoDAO.selecionarRemanejamentoPorID(remanejamento.getId());
                    ...
                    message.setCode(2);
                    message.setMessage("Não foi possível obter os dados do remanejamento!");
