 ...
 * @version 1.0
 */
public class JsonReautenticarUsuario extends javax.servlet.http.HttpServlet {
    ...
    protected void processRequest(javax.servlet.http.HttpServletRequest request, javax.servlet.http.HttpServletResponse response)
        ...
        try {
            ...
            if (com.settings.GerenciadorAcesso.checkAuthentication(token, userKey)) {
                ...
                if (! usuario.getUsuario().isEmpty() && usuario.getId() > 0 && usuario.getGrupo().getId() > 0 
                        && usuario.getDepartamento().getId() > 0) {
                    
                    com.settings.GerenciadorAcesso.updateAuthentication(usuario);
