 ...
 * @version 1.0
 */
public class JsonProcurarAnexoJudicialPorFundiaria extends javax.servlet.http.HttpServlet {
        ...
        try {
            ...
            if (com.settings.GerenciadorAcesso.checkAuthentication(token, userKey)) {
                ...
                if (anexo.getIdFundiaria() > 0) {
                    ...
                    java.util.List<com.doc.AnexoJudicial> anexos = anexoDAO.procurarAnexoJudicialPorIDFundiaria(anexo.getIdFundiaria());
