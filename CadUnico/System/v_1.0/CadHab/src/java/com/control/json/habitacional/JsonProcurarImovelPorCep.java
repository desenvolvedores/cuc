 ...
 * @version 1.0
 */
public class JsonProcurarImovelPorCep extends javax.servlet.http.HttpServlet {
        ...
        try {
            ...
            if (com.settings.GerenciadorAcesso.checkAuthentication(token, userKey)) {
                ...
                if (! endereco.getCEP().isEmpty()) {
                    ...
                    java.util.List<com.sys.habitacional.Imovel> imoveis = imovelDAO.procurarImovelPorCEP(endereco.getCEP());
                    ...
                    message.setCode(2);
                    message.setMessage("Você precisa informar o CEP do imóvel para efetuar a pesquisa!");
