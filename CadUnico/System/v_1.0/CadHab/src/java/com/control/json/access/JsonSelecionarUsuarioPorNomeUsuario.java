 ...
 * @version 1.0
 */
public class JsonSelecionarUsuarioPorNomeUsuario extends javax.servlet.http.HttpServlet {
        ...
        try {
            ...
            if (com.settings.GerenciadorAcesso.checkAuthentication(token, userKey)) {
                ...
                if (! usuario.getUsuario().isEmpty()) {
                    ...
                    usuario = usuarioDAO.selecionarUsuarioPorNomeUsuario(usuario.getUsuario());
