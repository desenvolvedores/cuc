 ...
 * @version 1.0
 */
public class JsonSelecionarEscolaridadeIndividuo extends javax.servlet.http.HttpServlet {
        ...
        try {
            ...
            if (com.settings.GerenciadorAcesso.checkAuthentication(token, userKey)) {
                ...
                if (escolaridade.getId() > 0) {
                    ...
                    escolaridade = escolaridadeDAO.selecionarEscolaridadeIndividuoPorID(escolaridade.getId());
