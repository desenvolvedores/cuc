 ...
 * @version 1.0
 */
public class JsonProcurarAnexoImovelPorImovel extends javax.servlet.http.HttpServlet {
        ...
        try {
            ...
            if (com.settings.GerenciadorAcesso.checkAuthentication(token, userKey)) {
                ...
                if (anexo.getIdImovel() > 0) {
                    ...
                    java.util.List<com.doc.AnexoImovel> anexos = anexoDAO.procurarAnexoImovelPorIDImovel(anexo.getIdImovel());
