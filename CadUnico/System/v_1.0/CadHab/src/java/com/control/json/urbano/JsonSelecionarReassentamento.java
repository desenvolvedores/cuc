 ...
 * @version 1.0
 */
public class JsonSelecionarReassentamento extends javax.servlet.http.HttpServlet {
        ...
        try {
            ...
            if (com.settings.GerenciadorAcesso.checkAuthentication(token, userKey)) {
                ...
                if (reassentamento.getId() > 0) {
                    ...
                    reassentamento = reassentamentoDAO.selecionarReassentamentoPorID(reassentamento.getId());
