 ...
 * @version 1.0
 */
public class JsonSelecionarCertidaoIndividuo extends javax.servlet.http.HttpServlet {
        ...
        try {
            ...
            if (com.settings.GerenciadorAcesso.checkAuthentication(token, userKey)) {
                ...
                if (certidao.getId() > 0) {
                    ...
                    certidao = certidaoDAO.selecionarCertidaoIndividuoPorID(certidao.getId());
