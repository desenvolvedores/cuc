 ...
 * @version 1.0
 */
public class JsonProcurarNucleoPorOrigem extends javax.servlet.http.HttpServlet {
    ...
    protected void processRequest(javax.servlet.http.HttpServletRequest request, javax.servlet.http.HttpServletResponse response)
        ...
        try {
            ...
            if (com.settings.GerenciadorAcesso.checkAuthentication(token, userKey)) {
                ...
                if (! nucleo.getOrigem().isEmpty()) {
                    
                    pgsql.sys.urbano.NucleoDAO nucleoDAO = new pgsql.sys.urbano.NucleoDAO();
                    java.util.List<com.sys.urbano.Nucleo> nucleos = nucleoDAO.procurarNucleoPorOrigem(nucleo.getOrigem());
                    ...
                    message.setCode(2);
                    message.setMessage("Você precisa informar a origem do núcleo para realizar a pesquisa!");
