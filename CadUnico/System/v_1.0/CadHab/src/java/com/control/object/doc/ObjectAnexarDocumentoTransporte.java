 ...
 * @version 1.0
 */
public class ObjectAnexarDocumentoTransporte extends javax.servlet.http.HttpServlet {
    ...
    protected void processRequest(javax.servlet.http.HttpServletRequest request, javax.servlet.http.HttpServletResponse response)
        ...
        try {
            ...
            if (com.settings.GerenciadorAcesso.checkAuthentication(token, userKey)) {
                ...
                long idNucleo = Integer.parseInt(request.getParameter("id_nucleo"));
                
                if (idNucleo > 0) {
                    
                    String pathDir = com.sys.SystemSettings.attachmentPath + "\\documentos\\nucleos\\anexos\\transporte\\" + idNucleo;
                    ...
                    if (! fileName.isEmpty()) {
                        ...
                        com.conn.ConnectionManager.connect("/anexo_transporte/salvar?auth_token=" + token + "&auth_key=" + userKey, input);
