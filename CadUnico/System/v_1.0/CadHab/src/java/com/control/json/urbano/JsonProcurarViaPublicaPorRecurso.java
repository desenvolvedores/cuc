 ...
 * @version 1.0
 */
public class JsonProcurarViaPublicaPorRecurso extends javax.servlet.http.HttpServlet {
    ...
    protected void processRequest(javax.servlet.http.HttpServletRequest request, javax.servlet.http.HttpServletResponse response)
        ...
        try {
            ...
            if (com.settings.GerenciadorAcesso.checkAuthentication(token, userKey)) {
                ...
                if (via.getMobilidade().getId() > 0) {
                    
                    pgsql.sys.urbano.ViaPublicaDAO viaDAO = new pgsql.sys.urbano.ViaPublicaDAO();
                    java.util.List<com.sys.urbano.ViaPublica> vias = viaDAO.procurarViaPublicaPorIDRecurso(via.getMobilidade());
                    ...
                    message.setCode(2);
                    message.setMessage("Não foi possível obter os dados de via pública!");
            ...
            com.sys.Message message = new com.sys.Message();
            message.setCode(0);
            message.setMessage("O servidor não pôde obter os dados de via pública!");
            com.data.MessageManager messMgr = new com.data.MessageManager();
            out.print(messMgr.parseJson(message));
            ...
            com.sys.Message message = new com.sys.Message();
            message.setCode(0);
            message.setMessage("O banco de dados retornou um erro durante a seleção dos dados de via pública.<br />Contate o administrador do sistema!");
            com.data.MessageManager messMgr = new com.data.MessageManager();
            out.print(messMgr.parseJson(message));
