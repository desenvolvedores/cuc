 ...
 * @version 1.0
 */
public class ObjectAnexarDocumentoJudicial extends javax.servlet.http.HttpServlet {
            ...
            if (com.settings.GerenciadorAcesso.checkAuthentication(token, userKey)) {
                ...
                if (idFundiaria > 0) {
                    ...
                    if (! fileName.isEmpty()) {
                        ...
                        com.conn.ConnectionManager.connect("/anexo_judicial/salvar?auth_token=" + token + "&auth_key=" + userKey, input);
