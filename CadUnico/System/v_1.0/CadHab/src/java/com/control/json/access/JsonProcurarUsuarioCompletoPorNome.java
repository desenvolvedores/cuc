 ...
 * @version 1.0
 */
public class JsonProcurarUsuarioCompletoPorNome extends javax.servlet.http.HttpServlet {
        ...
        try {
            ...
            if (com.settings.GerenciadorAcesso.checkAuthentication(token, userKey)) {
                ...
                if (! usuario.getNome().isEmpty()) {
                    ...
                    java.util.List<com.access.Usuario> usuarios = usuarioDAO.procurarUsuariosCompletosPorNome(usuario.getNome());
