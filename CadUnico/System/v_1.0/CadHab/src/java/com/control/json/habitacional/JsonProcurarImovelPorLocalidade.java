 ...
 * @version 1.0
 */
public class JsonProcurarImovelPorLocalidade extends javax.servlet.http.HttpServlet {
    ...
    protected void processRequest(javax.servlet.http.HttpServletRequest request, javax.servlet.http.HttpServletResponse response)
        ...
        try {
            ...
            if (com.settings.GerenciadorAcesso.checkAuthentication(token, userKey)) {
                ...
                if (! imovel.getLocalidade().isEmpty()) {
                    
                    pgsql.sys.habitacional.ImovelDAO imovelDAO = new pgsql.sys.habitacional.ImovelDAO();
                    java.util.List<com.sys.habitacional.Imovel> imoveis = imovelDAO.procurarImovelPorLocalidade(imovel.getLocalidade());
                    ...
                    message.setCode(2);
                    message.setMessage("Você precisa informar a localidade do imóvel para efetuar a pesquisa!");
