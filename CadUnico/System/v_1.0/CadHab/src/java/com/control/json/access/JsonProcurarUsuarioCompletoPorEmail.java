 ...
 * @version 1.0
 */
public class JsonProcurarUsuarioCompletoPorEmail extends javax.servlet.http.HttpServlet {
        ...
        try {
            ...
            if (com.settings.GerenciadorAcesso.checkAuthentication(token, userKey)) {
                ...
                if (! usuario.getEmail().isEmpty()) {
                    ...
                    java.util.List<com.access.Usuario> usuarios = usuarioDAO.procurarUsuariosCompletosPorEmail(usuario.getEmail());
