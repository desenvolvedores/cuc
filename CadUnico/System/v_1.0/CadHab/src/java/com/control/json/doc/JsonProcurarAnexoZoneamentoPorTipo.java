 ...
 * @version 1.0
 */
public class JsonProcurarAnexoZoneamentoPorTipo extends javax.servlet.http.HttpServlet {
        ...
        try {
            ...
            if (com.settings.GerenciadorAcesso.checkAuthentication(token, userKey)) {
                ...
                if (anexo.getIdFundiaria() > 0 && ! String.valueOf(anexo.getTipo()).isEmpty()) {
                    ...
                    java.util.List<com.doc.AnexoZoneamento> anexos = anexoDAO.procurarAnexoZoneamentoPorTipo(anexo.getIdFundiaria(), anexo.getTipo());
