 ...
 * @version 1.0
 */
public class JsonProcurarNucleoPorRendaPopulacao extends javax.servlet.http.HttpServlet {
    ...
    protected void processRequest(javax.servlet.http.HttpServletRequest request, javax.servlet.http.HttpServletResponse response)
        ...
        try {
            ...
            if (com.settings.GerenciadorAcesso.checkAuthentication(token, userKey)) {
                ...
                if (! nucleo.getRendaPopulacao().isEmpty()) {
                    
                    pgsql.sys.urbano.NucleoDAO nucleoDAO = new pgsql.sys.urbano.NucleoDAO();
                    java.util.List<com.sys.urbano.Nucleo> nucleos = nucleoDAO.procurarNucleoPorRendaPopulacao(nucleo.getRendaPopulacao());
                    ...
                    message.setCode(2);
                    message.setMessage("Você precisa informar a renda da população do núcleo para realizar a pesquisa!");
