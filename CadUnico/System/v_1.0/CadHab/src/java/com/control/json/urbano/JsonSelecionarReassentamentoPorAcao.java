 ...
 * @version 1.0
 */
public class JsonSelecionarReassentamentoPorAcao extends javax.servlet.http.HttpServlet {
    ...
    protected void processRequest(javax.servlet.http.HttpServletRequest request, javax.servlet.http.HttpServletResponse response)
        ...
        try {
            ...
            if (com.settings.GerenciadorAcesso.checkAuthentication(token, userKey)) {
                ...
                if (reassentamento.getIdAcao() > 0) {
                    
                    pgsql.sys.urbano.ReassentamentoDAO reassentamentoDAO = new pgsql.sys.urbano.ReassentamentoDAO();
                    reassentamento = reassentamentoDAO.selecionarReassentamentoPorIDAcao(reassentamento.getIdAcao());
                    out.print(jsonMgr.parseJson(reassentamento));
                    
                } else {
                    
                    com.sys.Message message = new com.sys.Message();
                    message.setCode(2);
                    message.setMessage("Não foi possível obter os dados do reassentamento!");
            ...
            com.sys.Message message = new com.sys.Message();
            message.setCode(0);
            message.setMessage("O servidor não pôde obter os dados do reassentamento!");
            com.data.MessageManager messMgr = new com.data.MessageManager();
            out.print(messMgr.parseJson(message));
            ...
            com.sys.Message message = new com.sys.Message();
            message.setCode(0);
            message.setMessage("O banco de dados retornou um erro durante a seleção dos dados do reassentamento.<br />Contate o administrador do sistema!");
            com.data.MessageManager messMgr = new com.data.MessageManager();
            out.print(messMgr.parseJson(message));
