 ...
 * @version 1.0
 */
public class JsonProcurarNucleoPorPadraoConstrutivo extends javax.servlet.http.HttpServlet {
    ...
    protected void processRequest(javax.servlet.http.HttpServletRequest request, javax.servlet.http.HttpServletResponse response)
        ...
        try {
            ...
            if (com.settings.GerenciadorAcesso.checkAuthentication(token, userKey)) {
                ...
                if (! nucleo.getPadraoConstrutivo().isEmpty()) {
                    
                    pgsql.sys.urbano.NucleoDAO nucleoDAO = new pgsql.sys.urbano.NucleoDAO();
                    java.util.List<com.sys.urbano.Nucleo> nucleos = nucleoDAO.procurarNucleoPorPadraoConstrutivo(nucleo.getPadraoConstrutivo());
                    out.print(jsonMgr.parseJsonListaNucleo(nucleos));
                    
                } else {
                    
                    com.sys.Message message = new com.sys.Message();
                    message.setCode(2);
                    message.setMessage("Você precisa informar o padrão construtivo do núcleo para realizar a pesquisa!");
