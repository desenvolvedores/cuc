 ...
 * @version 1.0
 */
public class JsonSelecionarDepartamento extends javax.servlet.http.HttpServlet {
        ...
        try {
            ...
            if (com.settings.GerenciadorAcesso.checkAuthentication(token, userKey)) {
                ...
                if (departamento.getId() > 0) {
                    ...
                    departamento = departamentoDAO.selecionarDepartamentoPorID(departamento.getId());
