 ...
 * @version 1.0
 */
public class JsonSelecionarDesconstrucao extends javax.servlet.http.HttpServlet {
        ...
        try {
            ...
            if (com.settings.GerenciadorAcesso.checkAuthentication(token, userKey)) {
                ...
                if (desconstrucao.getId() > 0) {
                    ...
                    desconstrucao = desconstrucaoDAO.selecionarDesconstrucaoPorID(desconstrucao.getId());
