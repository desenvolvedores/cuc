 ...
 * @version 1.0
 */
public class JsonProcurarImovelPorLogradouro extends javax.servlet.http.HttpServlet {
        ...
        try {
            ...
            if (com.settings.GerenciadorAcesso.checkAuthentication(token, userKey)) {
                ...
                if (! endereco.getLogradouro().isEmpty()) {
                    ...
                    java.util.List<com.sys.habitacional.Imovel> imoveis = imovelDAO.procurarImovelPorLogradouro(endereco.getLogradouro());
                    ...
                    message.setCode(2);
                    message.setMessage("Você precisa informar o logradouro do imóvel para efetuar a pesquisa!");
