 ...
 * @version 1.0
 */
public class JsonProcurarAnexoTransportePorNucleo extends javax.servlet.http.HttpServlet {
        ...
        try {
            ...
            if (com.settings.GerenciadorAcesso.checkAuthentication(token, userKey)) {
                ...
                if (anexo.getIdNucleo() > 0) {
                    ...
                    java.util.List<com.doc.AnexoTransporte> anexos = anexoDAO.procurarAnexoTransportePorIDNucleo(anexo.getIdNucleo());
