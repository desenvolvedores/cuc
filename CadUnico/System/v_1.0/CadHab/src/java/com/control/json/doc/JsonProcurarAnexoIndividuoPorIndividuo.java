 ...
 * @version 1.0
 */
public class JsonProcurarAnexoIndividuoPorIndividuo extends javax.servlet.http.HttpServlet {
        ...
        try {
            ...
            if (com.settings.GerenciadorAcesso.checkAuthentication(token, userKey)) {
                ...
                if (anexo.getIdIndividuo() > 0) {
                    ...
                    java.util.List<com.doc.AnexoIndividuo> anexos = anexoDAO.procurarAnexoIndividuoPorIDIndividuo(anexo.getIdIndividuo());
