 ...
 * @version 1.0
 */
public class JsonProcurarNucleoPorOcupacao extends javax.servlet.http.HttpServlet {
    ...
    protected void processRequest(javax.servlet.http.HttpServletRequest request, javax.servlet.http.HttpServletResponse response)
        ...
        try {
            ...
            if (com.settings.GerenciadorAcesso.checkAuthentication(token, userKey)) {
                ...
                if (! nucleo.getOcupacao().isEmpty()) {
                    
                    pgsql.sys.urbano.NucleoDAO nucleoDAO = new pgsql.sys.urbano.NucleoDAO();
                    java.util.List<com.sys.urbano.Nucleo> nucleos = nucleoDAO.procurarNucleoPorOcupacao(nucleo.getOcupacao());
                    ...
                    message.setCode(2);
                    message.setMessage("Você precisa informar o tipo de ocupação do núcleo para realizar a pesquisa!");
