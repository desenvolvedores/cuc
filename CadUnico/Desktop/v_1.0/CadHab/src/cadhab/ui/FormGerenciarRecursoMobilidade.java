 ...
 * @version 1.0
 */
public class FormGerenciarRecursoMobilidade extends javax.swing.JInternalFrame {
    
    private char acao = ' ';

    /**
     * Creates new form FormGerenciarRecursoMobilidade
     */
    public FormGerenciarRecursoMobilidade() {
    ...
    private void initComponents() {
        ...
        jtblPesquisa.setNextFocusableComponent(jtxtNomeRecurso);
        ...
        jtblPesquisa.getColumnModel().getColumn(1).setMinWidth(700);
        jtblPesquisa.getColumnModel().getColumn(1).setPreferredWidth(700);
        ...
        jtxtNomeRecurso.setNextFocusableComponent(jbtnNovo);
        ...
        try {
            ...
            if (! nome.isEmpty()) {
                ...
                if (output == null) {
                    ...
                    java.lang.Object opcao = javax.swing.JOptionPane.showOptionDialog(this, "Deseja realmente inserir o novo recurso de acesso no sistema?", "CadHab",
                            javax.swing.JOptionPane.DEFAULT_OPTION, javax.swing.JOptionPane.QUESTION_MESSAGE, null,
                            options, options[1]);

                    if (opcao.toString().equals("0")) {

                        output = cadhab.conn.ConnectionManager.connect("/recurso_mobilidade/salvar?auth_token=" + cadhab.CadHab.usuario.getToken() + "&auth_key=" + cadhab.CadHab.usuario.getUserKey(), input);   
                        ...
                        if (output != null) {
                            ...
                            javax.swing.JOptionPane.showMessageDialog(this, "Não foi possível fazer o cadastro do novo recurso de acesso!", "CadHab", 0);
                    ...
                    javax.swing.JOptionPane.showMessageDialog(this, "Já existe um recurso de acesso com este nome cadastrado no sistema!", "CadHab", 2);
        ...
        try {
            ...
            if (! nome.isEmpty()) {
                ...
                if (output == null) {
                    ...
                    java.lang.Object[] options = {"Sim", "Não"};
                    java.lang.Object opcao = javax.swing.JOptionPane.showOptionDialog(this, "Deseja realmente atualizar os dados do recurso de acesso no sistema?", "CadHab",
                            javax.swing.JOptionPane.DEFAULT_OPTION, javax.swing.JOptionPane.QUESTION_MESSAGE, null,
                            options, options[1]);

                    if (opcao.toString().equals("0")) {

                        output = cadhab.conn.ConnectionManager.connect("/recurso_mobilidade/atualizar?auth_token=" + cadhab.CadHab.usuario.getToken() + "&auth_key=" + cadhab.CadHab.usuario.getUserKey(), input);   
                        ...
                        if (output != null) {
                            ...
                            javax.swing.JOptionPane.showMessageDialog(this, "Não foi possível atualizar os dados do recurso de acesso!", "CadHab", 0);
    ...
    private void excluir() {
        ...
        try {
            ...
            if (jtblPesquisa.getSelectedRow() >= 0) {
                ...
                java.lang.Object output = cadhab.conn.ConnectionManager.connect("/recurso_mobilidade/id?auth_token=" + cadhab.CadHab.usuario.getToken() + "&auth_key=" + cadhab.CadHab.usuario.getUserKey(), input);
                
                if (output != null) {
                    
                    java.lang.Object[] options = {"Sim", "Não"};
                    java.lang.Object opcao = javax.swing.JOptionPane.showOptionDialog(this, "Deseja realmente excluir os dados do recurso de acesso do sistema?", "CadHab",
                            javax.swing.JOptionPane.DEFAULT_OPTION, javax.swing.JOptionPane.QUESTION_MESSAGE, null,
                            options, options[1]);

                    if (opcao.toString().equals("0")) {
                        
                        output = cadhab.conn.ConnectionManager.connect("/recurso_mobilidade/excluir?auth_token=" + cadhab.CadHab.usuario.getToken() + "&auth_key=" + cadhab.CadHab.usuario.getUserKey(), input);   
                        ...
                        if (output != null) {
                            ...
                            javax.swing.JOptionPane.showMessageDialog(this, "Não foi possível excluir os dados do recurso de acesso!", "CadHab", 0);
                    ...
                    javax.swing.JOptionPane.showMessageDialog(this, "Não foi possível encontrar os dados do recurso de acesso no sistema!", "CadHab", 0);
