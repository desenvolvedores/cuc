...
public class ReassentamentoDAO {
    ...
    public int inserirReassentamento(com.sys.urbano.Reassentamento reassentamento) 
        ...
        stmt.setLong(2, reassentamento.getAcao().getId());
    ...
    public com.sys.urbano.Reassentamento selecionarReassentamentoPorIDAcao(com.sys.urbano.AcaoNucleo acao) 
            throws java.lang.ClassNotFoundException, java.sql.SQLException {
    ...
    private com.sys.urbano.Reassentamento selecionar(java.sql.ResultSet rs) 
        ...
        if (rs.next()) {
            ...
            com.sys.urbano.Reassentamento reassentamento = new com.sys.urbano.Reassentamento(acao);
