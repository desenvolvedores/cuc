...
public class TelefoneIndividuoDAO extends TelefoneDAO {
    ...
    public int inserirTelefone(com.sys.social.TelefoneIndividuo telefone) 
    ...
    public com.sys.social.TelefoneIndividuo selecionarTelefonePorID(long id) 
            throws java.lang.ClassNotFoundException, java.sql.SQLException {
    ...
    public java.util.List<com.sys.social.TelefoneIndividuo> procurarTelefonesPorIDIndividuo(long idIndividuo) 
            throws java.lang.ClassNotFoundException, java.sql.SQLException {
    ...
    private com.sys.social.TelefoneIndividuo selecionar(java.sql.ResultSet rs) 
            throws java.sql.SQLException {
        
        if (rs.next()) {
            com.sys.social.TelefoneIndividuo telefone = new com.sys.social.TelefoneIndividuo();
    ...
    private java.util.List<com.sys.social.TelefoneIndividuo> listar(java.sql.ResultSet rs) 
            throws java.sql.SQLException {
        
        java.util.List<com.sys.social.TelefoneIndividuo> telefones = new java.util.ArrayList<>();
        while (rs.next()) {
            com.sys.social.TelefoneIndividuo telefone = new com.sys.social.TelefoneIndividuo();
            telefone.setId(rs.getLong("id"));
            telefone.setIdIndividuo(rs.getLong("id_individuo"));
