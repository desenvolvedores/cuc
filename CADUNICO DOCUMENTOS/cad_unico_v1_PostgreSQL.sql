...
CREATE TABLE nucleo (
	...
	area_total NUMERIC(10,5)    ,
	area_ocupada NUMERIC(10,5)    ,
...
CREATE TABLE telefone_individuo (
  id BIGSERIAL   NOT NULL ,
...
CREATE INDEX telefone_individuo_FK1 ON telefone_individuo (id_individuo);


CREATE INDEX IFK_telefone_individuo ON telefone_individuo (id_individuo);
...
CREATE TABLE composicao_imovel (
  ...
  num_areas_servico INTEGER    ,
  num_anexos INTEGER    ,
  num_outros_comodos INTEGER    ,
  num_serve_dormitorio INTEGER      ,
PRIMARY KEY(id, id_imovel)  ,
  FOREIGN KEY(id_imovel)
    REFERENCES imovel(id));
...
CREATE TABLE familias_individuo (
  id_familia BIGINT   NOT NULL ,
  id_individuo BIGINT   NOT NULL   ,
PRIMARY KEY(id_familia, id_individuo)    ,
...
CREATE INDEX familias_individuo_FK1 ON familias_individuo (id_familia);
CREATE INDEX familias_individuo_FK2 ON familias_individuo (id_individuo);


CREATE INDEX IFK_familias_individuo ON familias_individuo (id_familia);
CREATE INDEX IFK_individuo_familias ON familias_individuo (id_individuo);


CREATE TABLE familias_imovel (
  id_imovel BIGINT   NOT NULL ,
  id_familia BIGINT   NOT NULL   ,
PRIMARY KEY(id_imovel, id_familia)    ,
  FOREIGN KEY(id_familia)
    REFERENCES familias(id),
  FOREIGN KEY(id_imovel)
    REFERENCES imovel(id));
...
CREATE INDEX familias_imovel_FK1 ON familias_imovel (id_familia);
CREATE INDEX familias_imovel_FK2 ON familias_imovel (id_imovel);


CREATE INDEX IFK_familias_imovel ON familias_imovel (id_familia);
CREATE INDEX IFK_imovel_familias ON familias_imovel (id_imovel);
...
CREATE OR REPLACE FUNCTION fn_remover_acentos(CHARACTER VARYING)
