...
CREATE TABLE historico_habitacional (
	id BIGSERIAL   NOT NULL ,
	id_individuo BIGINT   NOT NULL ,
	id_imovel BIGINT   NOT NULL   ,
...
CREATE INDEX historico_habitacional_FK1 ON historico_habitacional (id_individuo);
CREATE INDEX historico_habitacional_FK2 ON historico_habitacional (id_imovel);


CREATE INDEX IFK_individuo_historico ON historico_habitacional (id_individuo);
CREATE INDEX IFK_imovel_historico ON historico_habitacional (id_imovel);
